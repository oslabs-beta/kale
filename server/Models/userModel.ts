...
const myURI: string = 'mongodb+srv://codesmithbv:ax6POS3lHiGRGPfO@kalecluster.3wl6slc.mongodb.net/';
...
const userSchema = new Schema<UserType>({ // Use generic type argument for UserType interface
